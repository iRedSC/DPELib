...
# In this example, we will give all players a unique ID, and then give them a pig with the same ID
# Then the pig will be teleported to its linked player
...
# We will run the function as all players to find their linked pigs

    # Notice the use of "at @s", this is because we will be needing the location context for teleporting the pig
